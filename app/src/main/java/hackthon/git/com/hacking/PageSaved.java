...
public class PageSaved extends PageView {


    public PageSaved(final Context context) {
        super(context);
        View view = LayoutInflater.from(context).inflate(R.layout.saved_content, null);
